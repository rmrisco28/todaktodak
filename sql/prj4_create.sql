...
(
    seq INT AUTO_INCREMENT NOT NULL,
    #   고유번호 order_no         VARCHAR(20)        NOT NULL UNIQUE,
    #   주문번호 sale_no          VARCHAR(20)        NOT NULL,
    #   판매번호 product_no       VARCHAR(20)        NOT NULL,
    #   상품 번호
    delivery_no      VARCHAR(20)        NOT NULL,
    #   배송번호 name             VARCHAR(50)        NOT NULL,
    #   주문자 이름
    ...
    #   배송비 total_prod_price INT                NOT NULL,
    #   상품 총 가격
...
#
주문 배송 정보 (ref: 판매상품)
# seq, 주문번호, 판매상품번호, 주문자 성함, 수령인,
# 수령인 연락처, 수령인 우편번호, 수령인 주소, 수령인 상세주소, 수령인 요청사항,
# 총 결제금액, 배송비, 전체 상품 금액, 상품금액, 주문수량,
# 대여기간, 주문상태, 배송업체명, 운송장번호, 주문일시(insertDttm),
# 수정일시, useYn, delYn
